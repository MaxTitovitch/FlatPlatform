                ...
                <div class="col-md-8">
                    <div class="panel panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="reserve_phone">{{ 'Запасной телефон' }}</label>
                                <input type="text" class="form-control" id="reserve_phone" name="reserve_phone" placeholder="{{ 'Запасной телефон' }}"
                                       value="{{ old('reserve_phone', $dataTypeContent->reserve_phone ?? '') }}">
                            </div>

                            <div class="form-group">
                                <label for="passport_number">{{ 'Номер Паспорта' }}</label>
                                <input type="number" class="form-control" id="passport_number" name="passport_number" placeholder="{{ 'Номер Паспорта' }}"
                                       value="{{ old('passport_number', $dataTypeContent->passport_number ?? '') }}">
                            </div>

                            <div class="form-group">
                                <label for="date_of_issue">{{ 'Дата Выдачи' }}</label>
                                <input type="date" class="form-control" id="date_of_issue" name="date_of_issue" placeholder="{{ 'Дата Выдачи' }}"
                                       value="{{ old('date_of_issue', $dataTypeContent->date_of_issue ?? '') }}">
                            </div>
